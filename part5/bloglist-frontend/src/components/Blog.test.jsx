...
describe('<Blog />', () => {
  ...
  test('renders correct content', () => {
    ...
    const elementByAuthor = screen.getByText('Robert C. Martin', { exact: false })
    expect(elementByAuthor).toBeDefined()
    const elementByUrl = screen.queryByText('https://react-testing-library.com', { exact: false })
  ...
  test('renders url and likes when button is clicked', async () => {
    ...
    const elementByUrl = screen.getByText('https://react-testing-library.com', { exact: false })
